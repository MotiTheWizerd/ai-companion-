description="Hi my name is Moti, Welcome back to our Semantix project, the is the chrome extesntion in which we connect the AI from its webside to our projt project
we working with pnpm, readt, in well desigend componenet event driven architcutre
...
We always talk before starting to code ❤️"
